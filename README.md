...
The students are also expected to write a Python program in a Jupyter Notebook to solve each of the following problems with the following instructions:
